...
This controller is used in Experiment~4b; Experiment~4a uses the multiplicative pacing described in the main paper. As an alternative to the multiplicative dual update of \citet{Balseiro2019Learning}, we implement a proportional--integral (PI) controller that operates directly on the cumulative spending error:
\begin{align}
