...
Table~\ref{tab:exp2a_ranked_vol} and the main effects plot (Figure~\ref{fig:e2a_main_vol}) show the factor rankings for price volatility under LinUCB. Model adequacy diagnostics confirm these findings (Appendix~\ref{sec:appendix_robustness}).

\input{tables/exp2a_ranked_vol}
...
Table~\ref{tab:exp2b_ranked_vol} and the main effects plot (Figure~\ref{fig:e2b_main_vol}) show the factor rankings for price volatility under Thompson Sampling. Model adequacy diagnostics confirm these findings (Appendix~\ref{sec:appendix_robustness}).

\input{tables/exp2b_ranked_vol}
