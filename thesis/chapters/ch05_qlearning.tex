...
Experiment~1a uses the ten-factor Resolution~V half-fraction described in Chapter~\ref{ch:design_and_inference}, yielding 1{,}024 observations. \Cref{tab:exp1a_params_summary} summarises the factors and their levels.
...
Robustness checks in Appendix~\ref{ch:robustness} confirm that these rankings survive multiple-testing correction, nonparametric model comparison, and quantile regression.
...
Robustness checks in Appendix~\ref{ch:robustness} confirm these rankings.
