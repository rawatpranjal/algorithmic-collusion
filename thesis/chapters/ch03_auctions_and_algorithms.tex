...
\end{tikzpicture}
\caption[The per-round decision loop for each algorithm family]{\textbf{The per-round decision loop for each algorithm family.} Each column shows the sequence of observation, action selection, bid submission, and parameter update, with a feedback arrow indicating that the cycle repeats.}
