...
\]
This is the efficient first-best benchmark. The factorial analysis in \cref{ch:qlearning} reports realised revenues rather than welfare, so the efficient benchmark enters the discussion only for comparison with the Price of Anarchy analysis in \cref{ch:pacing}.
