\begin{table}[H]
\centering
\caption[Experiment 2a: Significant effects for average revenue ($p < 0.05$), ranked by $|t|$]{\textbf{Experiment 2a: Significant effects for average revenue ($p < 0.05$), ranked by $|t|$.}}
