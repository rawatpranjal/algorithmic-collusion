\begin{table}[H]
\centering
\caption[Experiment 1a: significant effects for average revenue ($p < 0.05$), ranked by $|t|$]{\textbf{Experiment 1a: significant effects for average revenue ($p < 0.05$), ranked by $|t|$.}}
