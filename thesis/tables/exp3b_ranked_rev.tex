\begin{table}[H]
\centering
\caption[Experiment 3b: significant effects for average revenue ($p < 0.05$), ranked by $|t|$]{\textbf{Experiment 3b: significant effects for average revenue ($p < 0.05$), ranked by $|t|$.}}
