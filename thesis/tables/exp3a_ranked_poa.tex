\begin{table}[H]
\centering
\caption[Experiment 3a: significant effects for effective price of anarchy ($p < 0.05$), ranked by $|t|$]{\textbf{Experiment 3a: significant effects for effective price of anarchy ($p < 0.05$), ranked by $|t|$.}}
